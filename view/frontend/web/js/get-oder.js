define([
    ...
    return function(config) {
        var url = config.devhubUrl + 'refundrequest/order/index',
            title = config.devhubPopupTitle,
        ...
        var options = {
            ...
            buttons: [{
                ...
                click: function (data) {
                    var form_data = $("#devhub-refund-form").serialize();
                    if ($('#devhub-refund-form').valid()) {
                        ...
                        $.ajax({
                            ...
                            .done(function () {
                                $("#devhub-refund-modal").modal('closeModal');
                                $("#devhub-refund-form")[0].reset();
        ...
        $(document).on('click', '.refund-order', function () {
            ...
            modal(options, $("#devhub-refund-modal"));
            $("#devhub-refund-modal").modal('openModal');
            $(".devhub-refund-oder-id").attr('value', order_id);
        });
    }
});
